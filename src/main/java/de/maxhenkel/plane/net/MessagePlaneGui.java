...
public class MessagePlaneGui implements Message<MessagePlaneGui> {
    ...
    public static final CustomPacketPayload.Type<MessagePlaneGui> TYPE = new CustomPacketPayload.Type<>(Identifier.fromNamespaceAndPath(PlaneMod.MODID, "plane_gui"));
